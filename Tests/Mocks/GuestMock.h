...
public:
  ...
  MOCK_METHOD3(buyProperty,
               bool(unsigned int, const Estate *, const District &));
  MOCK_METHOD3(sellProperty, void(unsigned int, const Estate *property,
                                  const District &district));
  MOCK_METHOD1(checkPropertisInDistrict,
               unsigned int(const std::vector<const Estate *> &));
